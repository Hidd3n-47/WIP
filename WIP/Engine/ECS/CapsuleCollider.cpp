...
#ifdef _DEBUG
	dbgQuad = Quad(&size, { 0.0f, 0.0f, 1.0f, 1.0f }, entity->GetComponent<Transform>()->GetPositionPointer(), nullptr, TextureManager::Instance()->GetTexture(EngineTextureIndex::Dbg_Cap), 255, false);
	Dbg_Render(&dbgQuad);
#endif // _DEBUG
